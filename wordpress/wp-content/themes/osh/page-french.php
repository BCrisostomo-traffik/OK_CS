<?php include(locate_template('header-fr.php')); ?>

<div id="form-container" class="small-12 columns end" style="z-index:999;">
	<div id="form-inner">
		<div id="top-form" class="text-center">
			<h1><?php echo get_field('form_title_' . $language,11); ?></h1>
			<?php echo get_field('form_content_' . $language,11); ?>
		</div>
		...
		<div id="form_complete" class="text-center hide">
			<div class="inner">
				<?php echo get_field('thank_you_' . $language,11); ?>
			</div>
		</div>
...
<?php include(locate_template('footer-fr.php')); ?>
