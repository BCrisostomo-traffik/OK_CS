    ...
    <div class="large-6 columns blackbg">      
            ...
            <div class="row text-center">
                <div class="medium-12 large-offset-2 large-8 columns end">
                    <h1 class="neutraTilt">MERCI</h1>
                    <p class="neutraBold">Votre inscription a été reçue. Les participant sélectionnés seront prévenus par courriel ou par téléphone.</p>

                    <div class="text-center socialShare">
                        <p class="neutraBold">Partager : 
                            <a class="shareBtn" href="http://twitter.com/share?url=http%3A%2F%2Fsavourezlefroid.com&text=@baileyscanada%20m’a%20invité%20à%20%23savourerlefroid%20pour%20courir%20la%20chance%20de%20gagner%20un%20voyage%20à%20Whistler.%20Participez%20" data-size="medium" data-count="none" target="_blank"><img src="images/twitter-btn.png"></a> 
                                    <script>
                                        ! function(d, s, id) {
                            ...
                            <a class="shareBtn" title="Savourez Le Froid : Facebook" href="http://www.facebook.com/sharer.php?u=http://appstraffik.com/baileyscontest.com" target="_blank"><img src="images/fb-btn.png"></a>
                        </p>
                    </div>                  
                </div>
            </div>
